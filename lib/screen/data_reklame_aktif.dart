...
class DataReklameAktif extends StatefulWidget {
  const DataReklameAktif({Key? key}) : super(key: key);

  @override
  State<DataReklameAktif> createState() => _DataReklamePengajuanState();
}

class _DataReklamePengajuanState extends State<DataReklameAktif> {
